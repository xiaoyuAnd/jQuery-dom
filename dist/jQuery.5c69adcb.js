...
window.jQuery = function (selectorOrArray) {
  ...
  } else if (selectOrArray instanceof Object) {
  ...
  return {
    ...
    find: function find(selector) {
      ...
      for (var i = 0; i < elements.length; i++) {
        // console.log(element);
        array = array.concat(Array.from(elements[i].querySelectorAll(selector))); // console.log(element[i].querySelectorAll(selector));
      }
    ...
    children: function children() {
      var array = [];
      this.each(function (node) {
        array.push.apply(array, _toConsumableArray(node.child));
      });
      return jQuery(array);
    },
